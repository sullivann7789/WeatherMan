...
.then(function(data) {
    ...
    var rainorno = parseresults.weather[0].description
    ...
    $(".marketing-site-content-section").append("<div class='right'id ='"+ citynospace +"'><h3>"+ dayjs().format('dddd')+" in " + city +"<img class='icon' src='http://openweathermap.org/img/wn/"+ icon +  "@2x.png'>"+ "</h3><button class='save'>Save</button><button class='clear'>Clear</button><p>" + "Weather Description: "+rainorno+"<br> Temperature: " + temp + " F \n Feels like: " + feelslike +  " F \n Min Temp: " + tempmin + " F \n Max Temp: " + tempmax + " F \n Pressure: " + pressure + " hPa \n Humidity: " + humidity + " % " + "Wind Speed: " + wind + " Mp/h</p></div>");
